<div class="d-flex align-items-center mb-3">
    ...
    <h2 class="page-heading mb-0">Editar comentario interno</h2>
</div>
<?php if (!$comentario): ?>
<div class="alert alert-warning">Comentario no encontrado.</div>
<?php else: ?>
<?php if (!empty($error)): ?><div class="alert alert-danger"><?= htmlspecialchars($error) ?></div><?php endif; ?>
<div class="card shadow-sm" style="max-width:680px;">
    <div class="card-body">
        <form method="POST" action="comentario_interno.php?accion=actualizar&id=<?= $comentario['id_comentario'] ?>" novalidate id="frm">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="id_usuario_autor" class="form-select" required id="selAutor">
                        ...
                        <option value="<?= $u['id_usuario'] ?>"
                            <?= (int)$comentario['id_usuario_autor'] === (int)$u['id_usuario'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                    ...
                    <select name="id_paciente" class="form-select">
                        ...
                        <option value="<?= $p['id_paciente'] ?>"
                            <?= (int)($comentario['id_paciente'] ?? 0) === (int)$p['id_paciente'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="id_cita" class="form-control" min="1"
                           value="<?= htmlspecialchars($comentario['id_cita'] ?? '') ?>">
                </div>

                <div class="col-12">
                    <label class="form-label fw-semibold">Comentario <span class="text-danger">*</span></label>
                    <textarea name="comentario" class="form-control" rows="4" required id="txtComentario"><?= htmlspecialchars($comentario['comentario']) ?></textarea>
                ...
                <div class="col-12">
                    <div class="form-check">
                        <input type="checkbox" name="es_importante" id="es_importante"
                               ...
                               <?= $comentario['es_importante'] ? 'checked' : '' ?>>
