<div class="d-flex align-items-center mb-3">
    ...
    <h2 class="page-heading mb-0">Nueva especialidad</h2>
</div>
<div class="card shadow-sm" style="max-width:600px;">
    <div class="card-body">
        <form method="POST" action="especialidad.php?accion=crear" novalidate id="frm">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="descripcion" class="form-control" rows="3" maxlength="1000"><?= htmlspecialchars($_POST['descripcion'] ?? '') ?></textarea>
            </div>
